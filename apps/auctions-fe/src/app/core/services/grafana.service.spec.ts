...
describe('GrafanaService', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [GrafanaService, { provide: PLATFORM_ID, useValue: 'browser' }],
    });
  ...
  describe('error tracking', () => {
    ...
    it('should track error with string message', () => {
      ...
      expect(mockFaro.api.pushError).toHaveBeenCalledWith(jasmine.any(Error), jasmine.any(Object));
    });
  ...
  describe('SSR compatibility', () => {
    it('should not initialize in server environment', () => {
      ...
      TestBed.configureTestingModule({
        providers: [GrafanaService, { provide: PLATFORM_ID, useValue: 'server' }],
      });
