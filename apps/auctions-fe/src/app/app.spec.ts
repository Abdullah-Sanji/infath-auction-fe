...
describe('App', () => {
  ...
  beforeEach(async () => {
    ...
    gtmServiceMock = jasmine.createSpyObj('GtmService', ['initialize', 'pushPageView']);
  ...
  it('should track page views on navigation', () => {
    ...
    expect(gtmServiceMock.pushPageView).toHaveBeenCalledWith('/test-url', jasmine.any(String));
  });
